...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::spzLEFbg7ATobddN',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::zTHNv8fhJ2D8yRjf',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::lNoC4Bcd42OXZ1c9',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/admin/(?|u(?|sers/(?|edit/([^/]++)(*:42)|update/([^/]++)(*:64))|p\\-blog/(?|category/(?|edit/([^/]++)(*:108)|update/([^/]++)(*:131))|edit/([^/]++)(*:153)|update/([^/]++)(*:176)))|ad(?|min/(?|edit/([^/]++)(*:211)|update/([^/]++)(*:234))|vertizement/image/(?|edit/([^/]++)(*:277)|update/([^/]++)(*:300)))|blog/(?|category/(?|edit/([^/]++)(*:343)|update/([^/]++)(*:366))|tag/(?|edit/([^/]++)(*:395)|update/([^/]++)(*:418))|edit/([^/]++)(*:440)|update/([^/]++)(*:463))|c(?|o(?|mment/(?|status/([^/]++)(*:504)|upcoming/status/([^/]++)(*:536)|custom/status/([^/]++)(*:566))|ntact/(?|([^/]++)(*:592)|delete(*:606)|reply(*:619))|urse/(?|edit/([^/]++)(*:649)|update/([^/]++)(*:672)))|ustom\\-pages/(?|edit/([^/]++)(*:711)|update/([^/]++)(*:734)))|menu/(?|update/([^/]++)(*:767)|([^/]++)(*:783)|item/store/([^/]++)(*:810))|gallery/video/(?|category/(?|edit/([^/]++)(*:861)|update/([^/]++)(*:884))|edit/([^/]++)(*:906)|update/([^/]++)(*:929))|s(?|pecialties/image/(?|edit/([^/]++)(*:975)|update/([^/]++)(*:998))|ocial/(?|edit/([^/]++)(*:1029)|update/([^/]++)(*:1053))|idebar/store/([^/]++)(*:1084)))|/reset\\-password/([^/]++)(*:1120)|/blog(?|/(?|([^/]++)(*:1149)|by/search/([^/]++)(*:1176))|s/(?|category/([^/]++)(*:1208)|tag/([^/]++)(*:1229)))|/upcoming\\-blog(?|/([^/]++)(*:1267)|s/category/([^/]++)(*:1295))|/c(?|hambers/find/([^/]++)/([^/]++)(*:1340)|ourses/([^/]++)(*:1364))|/gallery/video/category/([^/]++)(*:1406)|/pages/([^/]++)(*:1430))/?$}sDu',
    ),
    3 => 
    array (
      42 => 
  ...
  array (
    ...
    return $request->user();
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"000000000000042b0000000000000000";}";s:4:"hash";s:44:"8faBICuJ0XhT3DB1myTtx3FlhbI8ptezlkQH+koHvm0=";}}',
        'namespace' => NULL,
        'prefix' => 'api',
        'where' => 
        array (
        ),
        'as' => 'generated::spzLEFbg7ATobddN',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    }";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"00000000000004410000000000000000";}";s:4:"hash";s:44:"vXQCDT+VRLf+2gtDVbF25AT9+FWQI8Wp0OjNBVYzhFE=";}}',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Front\\FrontController@up_blogs',
        'controller' => 'App\\Http\\Controllers\\Front\\FrontController@up_blogs',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\SidebarController@store',
        'controller' => 'App\\Http\\Controllers\\SidebarController@store',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\SidebarController@update',
        'controller' => 'App\\Http\\Controllers\\SidebarController@update',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
